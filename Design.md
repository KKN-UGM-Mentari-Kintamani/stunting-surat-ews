...
|1.3|**Phase 2 (Layanan Surat):** menambahkan semantik status surat (§1.3) yang telah dipetakan ke token `--status-*`; retensi PDF 7 hari (deviasi dari Master Doc §4, dicatat di `02_FLOW_PHASE_2.md`).|
